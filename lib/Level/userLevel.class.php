...
class UserLevel extends BasicLevel {
	 ...
	 * @param IUser $user A user instance for the current user.
	 * @param PDO $pdo A PDO instance to use for DB queries.
	 ...
	 *
	 * @return bool True on allowed or false on not allowed.
	 */
	 ...
	 *
	 * @return array Comments for the level or an empty array on failure.
	 */
	 ...
	 * CSRF.
	 *
	 * @return string "Secret" string on success or empty string if not logged in.
	 */
