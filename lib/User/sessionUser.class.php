...
/**
 * A full implementation of the IUser interface, extending the databaseUser
 * for the DB parts and adds session handeling and some security features.
 * @author Peter
 *
*/
class SessionUser extends DatabaseUser {
	...
	*/
	 ...
	 *
	 * @return bool true if success, or false on failrue
	 */
