...
class UserUtil {
	 ...
	 *
	 * @param PDO $pdo The pdo instance to run the query on
	 ...
	 *
	 * @param PDO $pdo the pdo instance to run the query on
	 * @return int Average levels per user or 0 on failure
	 */
	 ...
	 * Validates a password, lenght more than 4 chars and confirm
	 ...
	 * Makes sure a username is within 1-30 chars, only contains
	 * a-Z, 0-9, and underscore and isn't already registered.
	 *
	 *
	 * @param PDO $pdo The pdo instance to run the query on.
